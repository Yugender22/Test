...
import com.digit.customcamera.internal.CameraIntentKey;
...
public class MaterialCamera {
    ...
    public MaterialCamera(@NonNull Activity context) {
        ...
        mPrimaryColor = resolveColor(context, R.attr.colorPrimary);
    }
    ...
    public MaterialCamera(@NonNull android.app.Fragment context) {
        ...
        mPrimaryColor = resolveColor(mContext, R.attr.colorPrimary);
    }
  ...
  */
    ...
    public MaterialCamera instructions(@StringRes int stringRes) {
        mInstructions = stringRes;
        return this;
    }
    ...
    public Intent getIntent() {
        ...
        Intent intent =
                new Intent(mContext, cls)
                        ...
                        .putExtra(CameraIntentKey.FILE_PATH, mSaveDir)
        ...
        if (mInstructions != 0) intent.putExtra(CameraIntentKey.INSTRUCTIONS, mInstructions);
