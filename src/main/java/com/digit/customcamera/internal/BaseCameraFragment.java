...
import com.digit.customcamera.MaterialCamera;
...
abstract class BaseCameraFragment extends Fragment
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mInstruction = (TextView) view.findViewById(R.id.instruction);
        ...
        if (mInterface.instructions() != null) {
            mInfo.setVisibility(View.VISIBLE);
            mInfo.setOnClickListener(this);
            mInstruction.setVisibility(View.VISIBLE);
            String instruction = Arrays.toString(mInterface.instructions())
                    .replaceAll("\\[|\\]", "")
                    .replace(", ", "\n\n");
            mInstruction.setText(instruction);
            setImageRes(mInfo, R.drawable.ic_info);
        } else {
    ...
    protected final File getOutputMediaFile() {
        String filePath = getArguments().getString(CameraIntentKey.FILE_PATH);
        if (filePath != null) {
